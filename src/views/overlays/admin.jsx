          ...
          <div className="admin__content">
            ...
            <div className="admin__description">
              ...
              <ul className="admin__list">
                ...
                <li>Inloggen: Het wachtwoord is "IvM25051971". Na 5x fout inloggen wordt er automatisch ingelogd. </li>
                <li>Desktop en Windowmanager: Openen en slepen van mappen en vensters</li>
                <li>Explorer: Twee weergave mogelijkheden (lijst/iconen) en verkenning bestandsysteem (7x diep is overal hetzelfde)</li>
            ...
            <div className="admin__button-container">
              <button className="admin__button" onClick={this.props.dispatch.bind(null, overlay__fullscreen())}> Full Screen!</button>
